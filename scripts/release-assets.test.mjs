...
test("the committed v0.5.2 inventories and checksums pass the release preflight", () => {
...
test("the SBOM validator rejects missing and mismatched workspace identities", async () => {
  const source = path.join(repository, "docs/releases/nimanto-v0.5.2.cdx.json");
  ...
  await writeFile(
    target,
    original
      .replaceAll("pkg:npm/%40nimanto/api@0.5.2", "pkg:npm/%40nimanto/api@0.0.0")
      .replaceAll("pkg:npm/@nimanto/api@0.5.2", "pkg:npm/@nimanto/api@0.0.0"),
  );
  ...
  await writeFile(
    target,
    original
      .replaceAll("pkg:npm/%40nimanto/api@0.5.2", "pkg:npm/removed-api@0.5.2")
      .replaceAll("pkg:npm/@nimanto/api@0.5.2", "pkg:npm/removed-api@0.5.2"),
  );
