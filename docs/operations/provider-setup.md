...
Gmail and Microsoft Outlook sending are not implemented or configurable in v0.2.0. No access-token environment variable is read. Connected-account effects require the separately reviewed Slice 4 plan and exact approval before code or onboarding documentation is added.
